...
--
-- Host: localhost
-- Generation Time: Jan 17, 2011 at 08:57 AM
...
INSERT INTO `content` (`ID`, `current_version_id`, `type`, `order`, `parent`, `path`, `creator`, `created`, `active`, `menu`, `requires_authentication`, `deleted`, `scope`) VALUES
...
INSERT INTO `users` (`ID`, `username`, `password_hash`, `password_salt`, `email`, `active`, `joined`, `last_logged_in`, `banned`, `deleted`) VALUES
(1, 'Michael', '', '', '', 0, '2011-01-07 20:44:32', '0000-00-00 00:00:00', 0, 0);
...
ALTER TABLE `content`
  ...
  ADD CONSTRAINT `content_ibfk_4` FOREIGN KEY (`scope`) REFERENCES `scopes` (`ID`) ON DELETE NO ACTION ON UPDATE CASCADE;
